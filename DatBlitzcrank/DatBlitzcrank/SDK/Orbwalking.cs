...
namespace DatBlitzcrank.SDK
{
    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker()
            {
                Menu = MenuSDK.Menu.AddSubMenu("Drawing", "drawing");
                /* Drawings submenu */
                Menu.Add("AACircle", new CheckBox("AACircle", true));
                Menu.Add("AACircle2", new CheckBox("Enemy AA circle", false));
                Menu.Add("HoldZone", new CheckBox("HoldZone", false));
                Menu.Add("AALineWidth", new Slider("Line Width", 2, 1, 6));
                /*
                ...
                /* Misc options */
                Menu = MenuSDK.Menu.AddSubMenu("Misc", "Misc");
                Menu.Add("HoldPosRadius", new Slider("Hold Position Radius", 0, 0, 250));
                Menu.Add("PriorizeFarm", new CheckBox("Priorize farm over harass", true));
                Menu.Add("AttackWards", new CheckBox("Auto attack wards", false));
                Menu.Add("AttackPetsnTraps", new CheckBox("Auto attack pets & traps", true));
                Menu.Add("AttackBarrel", new CheckBox("Auto attack gangplank barrel", true));
                Menu.Add("Smallminionsprio", new CheckBox("Jungle clear small first", false));
                //Menu.Add("FocusMinionsOverTurrets", new KeyBind("Focus minions over objectives", false, KeyBind.BindTypes.PressToggle, 'M'));
                Menu.AddSeparator();
                ...
                */
                ...
                Menu.Add("FarmDelay", new Slider("Farm delay", 30, 0, 200));
                //_config.AddItem(
                ...
                Menu = MenuSDK.Menu.AddSubMenu("Mode", "Mode");
                ...
                Menu.AddGroupLabel("Attack Speed");
                Menu.Add("AttackSpeedLimiter.Enabled", new CheckBox("Enabled", false));
                Menu.Add("AttackSpeedLimiter.MaxAttackSpeed", new Slider("Limit Attack Speed [Recommend: 2150]:", 2150, 650, 3500));
                Menu.Add("AttackSpeedLimiter.LimitWhen", new Slider("1 = If I'm moving / kite mode, 2 = Everytime", 1, 1, 2));
            ...
            public static float AttackSpeedDelay
            {
                get
                {
                    if (Menu["AttackSpeedLimiter.Enabled"].Cast<CheckBox>().CurrentValue)
                    {
                        return ObjectManager.Player.AttackDelay;
                    }

                    var speed = (float)Menu["AttackSpeedLimiter.MaxAttackSpeed"].Cast<Slider>().CurrentValue;

                    switch (Menu["AttackSpeedLimiter.LimitWhen"].Cast<Slider>().CurrentValue)
                    {
                        case 1:
                            {
            ...
            {
                get { return Menu["FarmDelay"].Cast<Slider>().CurrentValue; }
            }
            ...
            {
                get { return Menu["MissileCheck"].Cast<CheckBox>().CurrentValue; }
            }
            ...
            */
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (Menu["Orbwalk"].Cast<KeyBind>().CurrentValue)
                    {
                        return OrbwalkingMode.Combo;
                    }

                    if (Menu["StillCombo"].Cast<KeyBind>().CurrentValue)
                    {
                        return OrbwalkingMode.Combo;
                    }

                    if (Menu["LaneClear"].Cast<KeyBind>().CurrentValue)
                    {
                        return OrbwalkingMode.LaneClear;
                    }

                    if (Menu["Farm"].Cast<KeyBind>().CurrentValue)
                    {
            ...
            public virtual AttackableUnit GetTarget()
            {
                ...
                if ((ActiveMode == OrbwalkingMode.Mixed || ActiveMode == OrbwalkingMode.LaneClear) &&
                    !Menu["PriorizeFarm"].Cast<CheckBox>().CurrentValue)
                {
                    ...
                    ActiveMode == OrbwalkingMode.LastHit)
                {
                    ...
                    foreach (var minion in MinionList)
                    {
                        ...
                        if (minion.Team != GameObjectTeam.Neutral && (Menu["AttackPetsnTraps"].Cast<CheckBox>().CurrentValue &&
                            minion.BaseSkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, Menu["AttackWards"].Cast<CheckBox>().CurrentValue)))
                        {
                            if (predHealth <= 0)
                            {
                        ...
                        if (minion.Team == GameObjectTeam.Neutral && (Menu["AttackBarrel"].Cast<CheckBox>().CurrentValue &&
                ...
                if (ActiveMode == OrbwalkingMode.LaneClear && (!Menu["FocusMinionsOverTurrets"].Cast<KeyBind>().CurrentValue || !MinionManager.GetMinions(ObjectManager.Player.Position, GetRealAutoAttackRange(ObjectManager.Player)).Any()))
                {
                    /* turrets */
                ...
                if (ActiveMode == OrbwalkingMode.LaneClear || ActiveMode == OrbwalkingMode.Mixed)
                {
                    ...
                    result = Menu["Smallminionsprio"].Cast<CheckBox>().CurrentValue
                    ...
                    if (!ShouldWait())
                    {
                        ...
                        result = (from minion in
                                      ObjectManager.Get<Obj_AI_Minion>()
                                          ...
                                          (Menu["AttackWards"].Cast<CheckBox>().CurrentValue || !MinionManager.IsWard(minion.BaseSkinName.ToLower())) &&
                                          (Menu["AttackPetsnTraps"].Cast<CheckBox>().CurrentValue && minion.BaseSkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, Menu["AttackWards"].Cast<CheckBox>().CurrentValue)) &&
            ...
            private void GameOnOnGameUpdate(EventArgs args)
            {
                try
                {
                    ...
                    Orbwalk(
                        ...
                        Menu["ExtraWindup"].Cast<Slider>().CurrentValue,
                        Math.Max(Menu["HoldPosRadius"].Cast<Slider>().CurrentValue, 30));
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
            ...
            {
                if (Menu["AACircle"].Cast<CheckBox>().CurrentValue)
                {
                    new Circle
                    {
                        Color = Color.LawnGreen,
                        BorderWidth = Menu["AALineWidth"].Cast<Slider>().CurrentValue,
                        Radius = GetRealAutoAttackRange(null) + 65
                ...
                if (Menu["AACircle2"].Cast<CheckBox>().CurrentValue)
                {
                        ...
                        EntityManager.Heroes.Enemies.FindAll(target => target.IsValidTarget(1175)))
                    {
                        new Circle
                        {
                            Color = Color.LawnGreen,
                            BorderWidth = Menu["AALineWidth"].Cast<Slider>().CurrentValue,
                            Radius = GetRealAutoAttackRange(target)
                ...
                if (Menu["HoldZone"].Cast<CheckBox>().CurrentValue)
                {
                    new Circle
                    {
                        Color = Color.Red,
                        BorderWidth = Menu["AALineWidth"].Cast<Slider>().CurrentValue,
                        Radius = Menu["HoldPosRadius"].Cast<Slider>().CurrentValue
                    }.Draw(Player.Position);
                    /*
                    Render.Circle.DrawCircle(
