...
namespace DatBlitzcrank.SDK
{
    ...
    public static class Prediction
    {
        ...
        internal static void Initialize()
        {
            ...
            {
                Menu = MenuSDK.Menu.AddSubMenu("Prediction", "Prediction");
                //var menu = new Menu("Prediction", "Prediction");

                Menu.Add("PredMaxRange", new Slider("Max Range %", 100, 70, 100));
        ...
        internal static PredictionOutput GetPrediction(PredictionInput input, bool ft, bool checkCollision)
        {
            ...
            else
            {
                ...
                {
                    input.Range = input.Range * Menu["PredMaxRange"].Cast<Slider>().CurrentValue / 100f;
                }
            }
